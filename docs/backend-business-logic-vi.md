...
| Quản lý CNC | `cnc_manager` | Điều phối sản xuất CNC | Giao Work Order cho CNC, xem tiến độ toàn xưởng, ưu tiên lệnh cắt |
| Vận hành CNC | `cnc` | Chạy máy, báo kết quả cắt | Xem lệnh cắt được giao, cập nhật trạng thái cắt, scan barcode (Kiosk) |
